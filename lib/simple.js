	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363330951850581@newsletter',
...
let canalId = ["120363330951850581@newsletter", "120363330951850581@newsletter", "120363330951850581@newsletter", "120363330951850581@newsletter", "120363330951850581@newsletter"]
let canalNombre = ["𝑻𝑬𝑹𝑩𝑶〔⚡️〕𝑩𝑶𝑻", "𝑻𝑬𝑹𝑩𝑶〔😜〕𝑩𝑶𝑻", "𝑻𝑬𝑹𝑩𝑶〔😺〕𝑬𝑳 𝑭𝑨𝑮𝑬𝑹", "𝑻𝑬𝑹𝑩𝑶〔😽〕𝑼𝑷𝑫𝑨𝑻𝑬", "𝑻𝑬𝑹𝑩𝑶〔😍〕𝑬𝑳 𝑮𝑨𝑴𝑬𝑫"]
