...
handler.all = async function(m) {
    ...
    try {
        ...
        global.kontak2 = [
            [owner[0], await conn.getName(owner[0] + '967738512629@s.whatsapp.net'), '𝗠𝗜𝗡𝗔𝗧𝗢-𝗕𝗢𝗧', 'https://whatsapp.com', true],
        ]
    ...
    global.adReply = {
        contextInfo: {
            ...
            externalAdReply: {
                ...
                previewType: "VIDEO",
                thumbnailUrl: logo,
                sourceUrl: 'https://chat.whatsapp.com/Cvnzii1Pd43A1XSmKwGAb6',
